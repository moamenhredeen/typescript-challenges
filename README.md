...
- [Pop](./src/challenges/pop.ts): `medium` `array`
- [Type Lookup](./src/challenges/type-lookup.ts): `medium` `union` `map`
- [TrimLeft](./src/challenges/trim-left.ts): `medium` `template-literal`
